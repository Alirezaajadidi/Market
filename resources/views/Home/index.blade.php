...
{{--                        <p class="pull-right">{{ \Illuminate\Support\Facades\Redis::get("views.{$course->id}.articles") }} بازدید</p>--}}
...
{{--                            <p class="pull-right">{{ \Illuminate\Support\Facades\Redis::get("views.{$article->id}.articles") }} بازدید</p>--}}
