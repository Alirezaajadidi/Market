...
<?php
$commentSuccessfulCount = \App\Models\Comment::where('approved', 1)->count();
$commentUnsuccessfulCount = \App\Models\Comment::where('approved', 0)->count();
$paymentSuccessfulCount = \App\Models\Payment::where('payment', 1)->count();
$paymentUnsuccessfulCount = \App\Models\Payment::where('payment', 0)->count();
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li><a href="/admin/payments">پرداختی های موفق <span class="badge">{{$paymentSuccessfulCount}}</span></a></li>
                <li><a href="/admin/payments/unsuccessful/page">پرداختی های ناموفق <span class="badge">{{$paymentUnsuccessfulCount}}</span></a></li>
            </ul>
            <ul class="nav nav-sidebar">
                @can('edit-article')
